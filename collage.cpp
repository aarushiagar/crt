...
menustart:
    ...
    cout << "\t\t\t............................" << endl;
    cout << " Enter Your Choose: that prehensher to mid ";
    cin >> choice;
    switch (choice)
    {
    case 1:
...
void student::modify() // Modify details of students
{
    system("cls");
    fstream file, file1;
    string rollno;
    ...
    {
        cout << "\nEnter Roll No. of Student which you want : ";
        cin >> rollno;
...
void student::search() // search data of student
{
    ...
    if (!file)
    {
        ...
        cout << "\n\t\t\tNo Data is Present... " << endl;
        cout << "Enter the roll number of the " << endl;
    }
